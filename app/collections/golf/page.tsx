...
import { ArrowLeft, Target, Wind, Sun, Activity } from 'lucide-react';
...
export default function GolfTrackerPage() {
  return (
    <div className="min-h-screen bg-zinc-950 text-white selection:bg-[#DFFF00] selection:text-black">
      ...
      {/* HEADER */}
      <div className="pt-24 pb-8 px-6 max-w-[1600px] mx-auto border-b border-zinc-800 mb-8">
