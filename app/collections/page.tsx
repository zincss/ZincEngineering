...
import { 
  ...
  BookOpen, ChefHat, Search, Globe, Orbit, Layers, 
  Database, ListOrdered
} from 'lucide-react'; 
import GlobalTicker from '../components/GlobalTicker';

// --- UTILITY: SPOTLIGHT CARD (Ported from Home) ---
        ...
        <div className="relative w-full max-w-[1400px] mx-auto px-6 flex flex-col items-center text-center">
          ...
          >
             <div className="inline-flex items-center gap-3 px-4 py-2 bg-zinc-900/60 border border-white/10 backdrop-blur-xl rounded-full shadow-2xl">
                ...
                <span className="text-[10px] font-mono font-bold text-zinc-400 tracking-[0.2em] uppercase">
                  Digital Archives
                </span>
             </div>
          </motion.div>
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-black tracking-tighter text-white uppercase leading-none select-none"
          >
            Collections<span className="text-zinc-600">.DB</span>
          </motion.h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-[320px] gap-6">
            ...
            <SpotlightCard className="md:col-span-8 rounded-[2.5rem]" spotlightColor="rgba(223, 255, 0, 0.15)">
                <Link href="/gaming" className="relative flex flex-col h-full w-full p-10 group z-30">
                    ...
                    <div className="relative z-10 flex justify-between items-start">
                        <div className="p-4 bg-zinc-950/50 backdrop-blur-md rounded-2xl border border-white/10 text-[#DFFF00]">
                            <Gamepad2 size={28} />
                        </div>
                        <div className="bg-zinc-950/80 backdrop-blur-md px-3 py-1 rounded-full border border-white/10">
                            <span className="text-[10px] font-mono font-bold text-zinc-400 uppercase">Warframe Market</span>
                        </div>
                    </div>

                    <div className="relative z-10 mt-auto">
                        <h2 className="text-5xl md:text-6xl font-black uppercase text-white mb-2 tracking-tighter">Gaming DB</h2>
                        <p className="text-zinc-400 font-mono text-sm leading-relaxed max-w-lg group-hover:text-[#DFFF00] transition-colors">
                ...
                <Link href="/collections/planetarium" className="relative flex flex-col h-full w-full p-8 group z-30">
                    <div className="absolute inset-0 z-0">
                        <Image 
                            ...
                            alt="Planetarium"
                            fill
                            className="object-cover opacity-40 group-hover:opacity-30 grayscale transition-transform duration-700 group-hover:scale-110"
                        />
                        <div className="absolute inset-0 bg-gradient-to-b from-blue-950/20 to-zinc-950/90" />
                    </div>
                    
                    <div className="relative z-10 flex justify-between items-start">
                        <div className="p-3 bg-blue-500/10 backdrop-blur-md rounded-2xl border border-blue-500/20 text-blue-400">
                            <Orbit size={24} />
                        </div>
                    </div>
            ...
            <SpotlightCard className="md:col-span-4 rounded-[2.5rem]">
                <Link href="/automotive" className="relative flex flex-col h-full w-full p-8 group">
                    ...
                    <div className="relative z-10 flex justify-between items-start">
                         <div className="p-3 bg-zinc-900/50 backdrop-blur-md rounded-2xl border border-white/10 text-zinc-400 group-hover:text-white">
                            <CarFront size={24} />
                        </div>
                ...
                <Link href="/collections/weather" className="relative flex flex-col h-full w-full p-8 group">
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-3xl font-black uppercase text-white tracking-tight">Weather<br/>Scanner</h2>
                         <p className="text-zinc-600 font-mono text-[10px] mt-2 group-hover:text-cyan-400 transition-colors">
                            AI Personality: Hostile
                        </p>
                    </div>
                </Link>
            </SpotlightCard>
            ...
            <SpotlightCard className="md:col-span-4 rounded-[2.5rem]" spotlightColor="rgba(34, 197, 94, 0.2)">
                <Link href="/collections/golf" className="relative flex flex-col h-full w-full p-8 group">
                    ...
                    <div className="relative z-10 flex flex-col h-full">
                        ...
                        <div>
                             <h2 className="text-3xl font-black uppercase text-white tracking-tight">Golf<br/>Scorecard</h2>
                             <p className="text-zinc-500 font-mono text-[10px] mt-2">4-Operative Capacity</p>
                        </div>
                    </div>
                </Link>
            </SpotlightCard>
                    ...
                    <div className="relative z-10 w-full">
                        <div className="flex items-center gap-3 mb-4">
                            <ChefHat className="text-orange-500" size={20} />
                             <span className="text-zinc-500 font-mono text-[10px] uppercase tracking-widest">Culinary DB</span>
                        </div>
                        <h2 className="text-4xl font-black uppercase text-white mb-2">Recipes</h2>
                        <p className="text-zinc-400 font-mono text-xs max-w-xs group-hover:text-white transition-colors">
                            Breakfast, Lunch, Dinner schematics.
                        </p>
                    </div>
                </Link>
            </SpotlightCard>
                ...
                <Link href="/collections/search" className="relative flex flex-col items-center justify-center h-full w-full p-8 group">
                     <div className="absolute inset-0 z-0">
                         <Image 
                            ...
                            alt="Search"
                            fill
                            className="object-cover opacity-20 group-hover:opacity-10 grayscale transition-transform duration-700 group-hover:scale-110"
                        />
                         <div className="absolute inset-0 bg-zinc-950/50" />
                    </div>

                    <div className="relative z-10 flex flex-col items-center">
                        <h2 className="text-4xl font-black text-white mb-6 tracking-tighter group-hover:scale-110 transition-transform duration-500">
                            <span className="text-[#DFFF00]">Z</span>INC
                        </h2>
                        <div className="w-64 h-10 rounded-full border border-zinc-600 bg-black/40 backdrop-blur-md flex items-center px-4 gap-3 group-hover:border-[#DFFF00] transition-colors">
                            <Search className="text-zinc-500" size={14} />
                            <span className="text-zinc-600 font-mono text-[10px] uppercase tracking-widest">Search Archive...</span>
                        </div>
                    </div>
                    
                    <div className="absolute bottom-6 right-6 flex items-center gap-2">
                        <Globe size={12} className="text-[#DFFF00]" />
                         <span className="text-[10px] font-mono font-bold text-zinc-500 uppercase">Global Web</span>
                    </div>
                </Link>
            </SpotlightCard>
            ...
            <SpotlightCard className="md:col-span-12 rounded-[2.5rem]" spotlightColor="rgba(255, 255, 255, 0.1)">
                <Link href="/collections/tier-list" className="relative flex items-end h-full w-full p-10 group">
                    ...
                    <div className="absolute top-10 right-10 flex flex-col gap-2 opacity-30 group-hover:opacity-100 transition-opacity duration-500">
                       <div className="w-16 h-2 bg-red-500 rounded-sm" />
                       <div className="w-12 h-2 bg-orange-500 rounded-sm" />
                       <div className="w-8 h-2 bg-yellow-500 rounded-sm" />
                    </div>

                    <div className="relative z-10 w-full">
                        <div className="flex items-center gap-3 mb-4">
                            <ListOrdered size={20} className="text-zinc-400" />
                            <span className="px-3 py-1 bg-zinc-800 text-zinc-300 font-bold text-[10px] uppercase tracking-widest rounded-full border border-white/5">Utility</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-black uppercase text-white mb-2">Hierarchy Builder</h2>
                        <p className="text-zinc-400 font-mono text-sm leading-relaxed max-w-lg group-hover:text-white transition-colors">
                            Tactical asset classification. Drag-and-drop ranking system with local persistence.
                        </p>
                    </div>
                </Link>
            </SpotlightCard>
