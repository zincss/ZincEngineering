...
export const PLANET_DATA: CelestialBody[] = [
    ...
    moons: [
      {
        ...
        name: "Sunforge Array",
        type: "Station",
        description: "A massive solar collector array shielding a research habitat. It bathes in the Sun's corona to power the inner system.",
        radius: 0.12,
        distance: 1.2, 
        orbitalPeriod: 3, 
        rotationPeriod: 0,
    ...
    moons: [
      {
        ...
        type: "Station",
        description: "A floating aerostat colony drifting high in the upper atmosphere where conditions are surprisingly habitable.",
        radius: 0.25,
        distance: 2.8, 
        orbitalPeriod: 5, 
        rotationPeriod: 0,
  ...
  },
  {
    ...
    moons: [
      ...
      },
      {
        ...
        name: "Zinc Orbital",
        type: "Station",
        description: "The primary transit hub for the Zinc Shuttle network. Connects Earth to the wider system.",
        radius: 0.1, 
        distance: 2.2, 
        orbitalPeriod: 0.15, // Fast LEO orbit
        rotationPeriod: 0,
        meanLongitude: 90, 
        axialTilt: 0,
        textureUrl: "",
    ...
    moons: [
      {
        ...
        name: "Ares Shipyards",
        type: "Station",
        description: "Orbital drydocks where the system's heavy cruisers are constructed using Martian ore.",
        radius: 0.15,
        distance: 1.8, 
        orbitalPeriod: 1.2,
        rotationPeriod: 0,
  ...
  },
  {
    ...
    name: "Kuva Fortress",
    type: "Station",
    description: "A moving Grineer fortress hidden in the asteroid belt. The Queens' surveillance network operates from here.",
    radius: 0.8, 
    distance: 450, 
    orbitalPeriod: 1500, 
    rotationPeriod: 48, 
    ...
    moons: [
        {
          ...
          type: "Station",
          description: "Oryx's flagship, parked within the rings of Saturn. An immense hive warship of impossible geometry.",
          radius: 0.6, 
          distance: 16, 
          orbitalPeriod: 10, 
          rotationPeriod: 0,
    ...
    moons: [
      {
         ...
         name: "Trident Relay",
         type: "Station",
         description: "The furthest major communication buoy in the system, acting as a lighthouse for deep space.",
         radius: 0.4,
         distance: 7.5,
         orbitalPeriod: 5.5,
         rotationPeriod: 0,
