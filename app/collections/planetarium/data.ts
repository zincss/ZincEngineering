    ...
    moons: [
      {
        ...
        radius: 0.008, // Tiny
        distance: 0.45, // Close to surface (0.38 radius)
        orbitalPeriod: 3, 
        rotationPeriod: 0,
        meanLongitude: 45,
        axialTilt: 0,
    ...
    moons: [
      {
        ...
        radius: 0.01, 
        distance: 1.1, // Just above atmosphere
        orbitalPeriod: 5, 
        rotationPeriod: 0,
        meanLongitude: 180,
        axialTilt: 0,
  ...
  },
  {
    ...
    moons: [
      ...
      },
      {
        ...
        radius: 0.01, 
        distance: 0.7, // Close orbit (Mars radius 0.53)
        orbitalPeriod: 1.2,
        rotationPeriod: 0,
        meanLongitude: 270,
        axialTilt: 0,
  ...
  },
  {
    ...
    moons: [
      ...
      },
      {
         ...
         radius: 0.05, 
         distance: 12, // Close to surface (Radius 11)
         orbitalPeriod: 6, 
         rotationPeriod: 0,
         meanLongitude: 0,
         axialTilt: 0,
    ...
    moons: [
        {
          ...
          radius: 0.05, 
          distance: 13, // Inside rings area (Radius 9)
          orbitalPeriod: 10, 
          rotationPeriod: 0,
          meanLongitude: 180, 
          axialTilt: 0,
