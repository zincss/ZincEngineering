...
import { useSimulation, FUEL_COST_PER_UNIT, BOOST_COST_PER_UNIT, getOrbitalPosition, HaulingJob } from '../context'; 
...
import { 
    ...
    UploadCloud, ArrowUpCircle, Container
} from 'lucide-react';
...
export function JobBoard({ onClose }: { onClose: () => void }) {
    const { availableJobs, acceptJob, activeJob, completeJob, credits, dockedAt, findBody, fuel, buyFuel, boost, buyBoost, currentShip } = useSimulation();
                            ...
                            {activeTab === 'dealership' && isDealershipAvailable ? (
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                        {/* Fuel Card (Modified to use currentShip.maxFuel) */}
                                        ...
                                        {/* Boost Card (Modified to use currentShip.maxBoost) */}
                                        <div className="bg-black/20 border border-white/10 rounded-xl p-4 flex flex-col justify-between h-full">
                                            <div className="flex items-center gap-3 mb-4">
