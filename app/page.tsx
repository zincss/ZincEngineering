...
import { Database, Cpu, Activity, ArrowRight, Shield, Crosshair, Zap, MessageSquare } from "lucide-react";
...
export default function Home() {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center relative px-4 py-12">
      ...
      {/* --- DEVELOPER NOTICE & CONTROLS --- */}
      <div className="max-w-6xl w-full mb-16 flex flex-col md:flex-row gap-6 items-end relative z-20">
          
          {/* Message Box */}
          <div className="flex-1 bg-zinc-50 dark:bg-zinc-900 border-l-4 border-acid p-4 shadow-sm transition-colors w-full">
            <div className="flex gap-4 items-start">
            <div className="shrink-0 mt-1">
                <div className="flex items-center justify-center w-8 h-8 bg-black dark:bg-white text-white dark:text-black rounded-sm transition-colors">
                    <MessageSquare size={16} />
                </div>
            </div>
            <div>
                <h3 className="font-black text-[10px] uppercase tracking-widest mb-1 text-zinc-400">INCOMING TRANSMISSION</h3>
                <p className="font-mono text-xs text-zinc-600 dark:text-zinc-300 leading-relaxed">
                    "Anyone is more than welcome to add me in-game. My username is <span className="font-bold text-black dark:text-black bg-acid px-1">Zincss</span>. I thought I would share my little passion project with you all."
                </p>
            </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl relative z-20">
        ...
        {/* 1. DATABASE CARD */}
        <Link href="/database" className="group relative h-80 border-2 border-black dark:border-white bg-white dark:bg-zinc-900 p-8 flex flex-col justify-between hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[12px_12px_0px_0px_rgba(255,255,255,1)] transition-all duration-300">
        ...
        {/* 2. MODULES CARD */}
        <Link href="/modules" className="group relative h-80 border-2 border-black dark:border-white bg-zinc-900 dark:bg-black text-white p-8 flex flex-col justify-between hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_#DFFF00] transition-all duration-300">
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
        ...
        {/* 3. MARKET CARD */}
        <Link href="/market" className="group relative h-80 border-2 border-black dark:border-white bg-white dark:bg-zinc-900 p-8 flex flex-col justify-between hover:-translate-y-2 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] dark:hover:shadow-[12px_12px_0px_0px_rgba(255,255,255,1)] transition-all duration-300">
            <div className="absolute top-0 right-0 p-4 opacity-10 group-hover:opacity-20 transition-opacity">
