...
export default function BackButton({ href, label = 'RETURN', className = '' }: BackButtonProps) {
  return (
    // OPTIMIZATION: Changed top-28/md:top-24 to top-28/md:top-28 (112px) for consistent header clearance
    <div className={`fixed top-28 left-4 md:top-28 md:left-6 z-50 animate-in fade-in slide-in-from-left-4 duration-700 pointer-events-auto ${className}`}>
         <Link 
            href={href} 
