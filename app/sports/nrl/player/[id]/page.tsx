...
import { ArrowLeft, Shield, TrendingUp, Users, FileText } from 'lucide-react';
...
export default async function NrlPlayerPage({ params }: { params: { id: string } }) {
  
  const data = await getOrFetchResource(
    { table: 'nrl_profiles', keyField: 'player_id', id: params.id },
