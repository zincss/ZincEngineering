                        ...
                        <table className="w-full text-left font-mono text-xs">
                            <thead>
                                <tr className="bg-zinc-950 text-zinc-500 border-b border-zinc-800">
                                    ...
                                    {STAT_CONFIG.map((h, i) => (
                                        <th key={i} className="p-4 font-black tracking-widest text-right text-white">{h.label}</th>
                                    ))}
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-zinc-800/50">
                                {logs && logs.length > 0 ? logs.map((game, i) => (
                                    ...
                                    <tr>
                                        <td colSpan={3 + STAT_CONFIG.length} className="p-12 text-center text-zinc-600 font-mono flex flex-col items-center gap-2">
                                            <History size={24} />
