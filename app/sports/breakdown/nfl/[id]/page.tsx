// app/sports/breakdown/nfl/[id]/page.tsx
import React from 'react';
import Link from 'next/link';
import { fetchGameAnalysis } from '@/app/sports/nfl/lib/espn';
import { ArrowLeft, TrendingUp, User, Info, AlertCircle, History, BarChart3, BrainCircuit } from 'lucide-react';

export const dynamic = 'force-dynamic';

export default async function NFLGameAnalysis(props: { params: Promise<{ id: string }> }) {
