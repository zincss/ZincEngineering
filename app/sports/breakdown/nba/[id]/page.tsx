// app/sports/breakdown/nba/[id]/page.tsx
import React from 'react';
import Link from 'next/link';
import { fetchGameAnalysis } from '@/app/sports/nba/lib/espn';
import { ArrowLeft, TrendingUp, User, Swords, Info, AlertCircle, History, BrainCircuit, BarChart3 } from 'lucide-react';

export const dynamic = 'force-dynamic';

export default async function NBAGameAnalysis(props: { params: Promise<{ id: string }> }) {
  const params = await props.params;
  const data = await fetchGameAnalysis(params.id);
